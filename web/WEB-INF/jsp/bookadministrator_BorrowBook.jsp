...
<div id="wrapper">
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">用户借阅办理</h1>
				<%--&lt;%&ndash; 提示信息&ndash;%&gt;--%>
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<form class="form-inline" method="get"
					  action="${pageContext.request.contextPath }/adminBorrowBook.action">
						...
						<tr>
							...
							<td>
								<a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#customerEditDialog" onclick= "editCustomer(${row.isbn})">查看</a>
									...
									<a href="#" class="btn btn-danger btn-xs" onclick="borrow(${row.isbn})">借阅</a>
							</td>
						</c:forEach>
						</tbody>
					</table>
					<div class="col-md-12 text-right">
						<mikon:page url="${pageContext.request.contextPath }/adminBorrowBook.action" />
					</div>
					<!-- /.panel-body -->
				</div>
				<!-- /.panel -->
...
<script type="text/javascript">
    ...
    function borrow(isbn) {
        if (confirm('确实要借阅该图书吗?')) {
            $.post("<%=basePath%>/borrowBook.action", {"isbn": isbn},
                function (data) {
                    if (data == "OK") {
                        alert("图书借阅成功！");
                        window.location.reload();
